...
const Carousel = () => {
  return (
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-row mb-3 ">
                    <div className="p-2">
                      ...
                      <span className="card-text">&nbsp 4</span>
                    </div>
                    <div className="p-2">
                      <i className="fa-solid fa-bath text-secondary"></i>
                      <span className="card-text">&nbsp 3</span>
                    </div>
                    <div className="p-2">
              ...
              <div className="card h-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-row mb-3 ">
                    <div className="p-2">
                      <i className="fa-solid fa-bed text-secondary"></i>
                      <span className="card-text">&nbsp 6</span>
                    </div>
                    <div className="p-2">
                      <i className="fa-solid fa-bath text-secondary"></i>
                      <span className="card-text">&nbsp 4.5</span>
                    </div>
                    <div className="p-2">
                      <i className="fa-solid fa-cube text-secondary"></i>
                      <span className="card-text">
                        &nbsp 1050m<sup>2</sup>
                      </span>
                    </div>
                  </div>
                  <a href="details.html" className="btn btn-primary btn-sm">
              ...
              <div className="card  h-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-row mb-3 ">
                    ...
                    <div className="p-2">
                      <i className="fa-solid fa-bath text-secondary"></i>
                      <span className="card-text">&nbsp 3.5</span>
                    </div>
                    <div className="p-2">
                      <i className="fa-solid fa-cube text-secondary"></i>
                      <span className="card-text">
              ...
              <div className="card  h-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-row mb-3 ">
                    <div className="p-2">
                      <i className="fa-solid fa-bed text-secondary"></i>
                      <span className="card-text">&nbsp 2</span>
                    </div>
                    <div className="p-2">
                      <i className="fa-solid fa-bath text-secondary"></i>
                      <span className="card-text">&nbsp 3.5</span>
              ...
              <div className="card  h-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-row mb-3 ">
                    ...
                    <div className="p-2">
                      <i className="fa-solid fa-bath text-secondary"></i>
                      <span className="card-text">&nbsp 25</span>
                    </div>
                    <div className="p-2">
                      <i className="fa-solid fa-cube text-secondary"></i>
                      <span className="card-text">
              ...
              <div className="card  h-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex flex-row mb-3 ">
                    <div className="p-2">
                      <i className="fa-solid fa-bed text-secondary"></i>
                      <span className="card-text">&nbsp 5</span>
                    </div>
                    <div className="p-2">
                      <i className="fa-solid fa-bath text-secondary"></i>
                      <span className="card-text">&nbsp 3.5</span>
    ...
    //         <div className={`${styles.carouselItem} active`}>
    ...
    //               height={500}
    //             />
    //             <Image src="/logoASF.svg" alt="Logo" width={150} height={150} />
    //             <div className="card-body">
    //               <h5 className="card-title text-secondary">
    //                 Departamento de venta
    //               </h5>
    ...
    //               </a>
    //             </div>
    //             <span className={`badge ${styles.badgeVenta}`}>Venta</span>
    //           </div>
    //         </div>
    //         <div className="carousel-item">
    //           <div className={`${styles.card} h-100`}>
    ...
    //               height={100}
    //             />
    //             <Image src="/logoASF.svg" alt="Logo" width={100} height={100} />
    //             <div className="card-body">
    //               <h5 className="card-title text-secondary">Casa de campo</h5>
    ...
    //               </a>
    //             </div>
    //             <span className={`badge ${styles.badgeArriendo}`}>
    //               Arriendo
    //             </span>
    //           </div>
    //         </div>
